                    ...
                    <div class="card text-white">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: #2d3748; color: #e2e8f0;">
                                    <span>User John Doe logged in.</span>
                                    <span class="badge bg-secondary">2 mins ago</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: #2d3748; color: #e2e8f0;">
                                    <span>New product "Widget X" added.</span>
                    ...
                    <div class="card text-white">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <button class="btn btn-primary" type="button"><i class="fas fa-plus-circle me-2"></i>Add New Product</button>
                                <button class="btn btn-primary" type="button"><i class="fas fa-chart-bar me-2"></i>View Reports</button>
                                <button class="btn btn-primary" type="button"><i class="fas fa-envelope-open-text me-2"></i>Send Newsletter</button>
                            </div>
                        </div>
                    </div>
                </div>
